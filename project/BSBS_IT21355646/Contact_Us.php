            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                <h1 class="text-center"><i class="fa fa-phone-square" aria-hidden="true"></i></h1>
                                <h2 class="text-center">+94112344561</h2>
                                <hr>
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" action="php/contactAction.php" method="POST">
